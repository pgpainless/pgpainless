...
`PGPainless::generateKey()` presents a selection of pre-configured OpenPGP key archetypes:
...
If you have special requirements on algorithms you can use `PGPainless::buildKey()` instead, which offers more
